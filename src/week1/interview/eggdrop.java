...
/*
For Version 0 :
Suppose the egg breaks from Tth floor and there is  1 egg and there are T tosses
Ans
Experiment throwing eggs from 1 to Tth floor incrementing 1
For Version 1:
There are logn tosses and log n eggs
...
version 3:
take 1 egg drop is at root(n) floor
and then
2*root(n) th floor

version 4

dropp the egg at( c/2)*root(t)
drop the egg at c * root(t)
 */
}
