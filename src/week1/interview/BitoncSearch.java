...
// [1,2,3,4,-1,-2,3]
        ...
        }else
        {
            ...
            }else if(descendingBinarySearch(a,bitonicindex+1,a.length-1,key)>0)//if found in decreasing sequence then return it
            {
    ...
    public int bitoincIndex(int a[],int lo,int hi)
    {
        ...
        // (mid-1<0 && a[mid]<a[mid+1] && a.length == 2) will handle only icreasing sequence arrays like [1,2] with size 2
// mid+1== a.length will handle a case where there are [1,2,3,4,5,6..] and [1] and [-1]
